        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <table>
                    ...
                    // Truy vấn SQL
                    $sql = "SELECT * FROM nguoidung, phanquyen WHERE idQuyen = 2 and phanquyen.idNguoiDung = nguoidung.idNguoiDung LIMIT 10"; // Thay 'ten_bang' bằng tên bảng bạn muốn truy vấn
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <th class="setting"><a href="">Sửa</a></th>
                                <th class="setting"><a href="">Xóa</a></th>
                            </tr>
                            ';
                        }
                    } else {
